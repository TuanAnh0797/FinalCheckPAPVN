...
--
-- Dumping data for table `datacheckfinaldetail`
--

LOCK TABLES `datacheckfinaldetail` WRITE;
/*!40000 ALTER TABLE `datacheckfinaldetail` DISABLE KEYS */;
/*!40000 ALTER TABLE `datacheckfinaldetail` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-12-14 23:20:11
